#!/bin/bash
# Complete 16-node BEAT distributed test
PASS='York@233'
...
echo "╔══════════════════════════════════════════════════════════╗"
echo "║  16-node BEAT Distributed Test - Complete               ║"
echo "╠══════════════════════════════════════════════════════════╣"
echo "║  N=$N, T=$T                                            ║"
echo "║  Nodes: ${#ALL_IPS[@]} servers                          ║"
echo "╚══════════════════════════════════════════════════════════╝"

# Step 1: Fix Python 3.10 compatibility
echo ""
echo "[Step 1] Fixing Python 3.10 compatibility issues..."
...
wait
echo "  Python 3.10 compatibility fixed"
...
# Step 3: Deploy hosts file to all nodes
echo ""
echo "[Step 3] Deploying hosts file to all nodes..."
for ip in "${ALL_IPS[@]}"; do
...
# Step 4: Generate threshold keys on first node
echo ""
echo "[Step 4] Generating threshold keys on node 0..."
...
# Step 5: Distribute keys to all nodes
echo ""
echo "[Step 5] Distributing keys to all nodes..."
