...
python -m adaptive.commoncoin.prf_generate_keys 4 2 > thsig4_1.keys
python -m adaptive.ecdsa.generate_keys_ecdsa 4 > ecdsa1.keys
python -m adaptive.threshenc.generate_keys 4 2 > thenc4_1.keys

python -m adaptive.commoncoin.prf_generate_keys 7 3 > thsig7_2.keys
python -m adaptive.ecdsa.generate_keys_ecdsa 7 > ecdsa2.keys
python -m adaptive.threshenc.generate_keys 7 3 > thenc7_2.keys
